...
class PosenetActivity :
  ...
  private fun draw(canvas: Canvas, person: Person, bitmap: Bitmap) {
    ...
    val distanceBetweenAnkles = Math.sqrt(

      Math.pow((person.keyPoints[15].position.x - person.keyPoints[16].position.x).toDouble(), 2.0)
              +
              Math.pow((person.keyPoints[15].position.y - person.keyPoints[16].position.y).toDouble(), 2.0)


    )

    val distanceLeftAnkleToLeftHip = Math.sqrt(

      Math.pow((person.keyPoints[15].position.x - person.keyPoints[11].position.x).toDouble(), 2.0)
              +
              Math.pow((person.keyPoints[15].position.y - person.keyPoints[11].position.y).toDouble(), 2.0)


    )

    val distanceRightAnkleToRightHip = Math.sqrt(

      Math.pow((person.keyPoints[16].position.x - person.keyPoints[12].position.x).toDouble(), 2.0)
              +
              Math.pow((person.keyPoints[16].position.y - person.keyPoints[12].position.y).toDouble(), 2.0)


    )

    val distanceLeftAnkleToNose = Math.sqrt(

      Math.pow((person.keyPoints[0].position.x - person.keyPoints[15].position.x).toDouble(), 2.0)
              +
    ...
    var footAngle = atan2(person.keyPoints[16].position.y.toDouble() - person.keyPoints[15].position.y.toDouble(),
      person.keyPoints[16].position.x.toDouble() - person.keyPoints[15].position.x.toDouble()) * 180 / PI
    footAngle += 180


    fun olliePosition(): String {
      Log.d("TAG", person.keyPoints[15].position.y.toString())
      if (
      ...
      if(
        (person.keyPoints[15].position.y > 100) and
        (person.keyPoints[15].position.y < 180) and
        (person.keyPoints[16].position.y > 180) and
    ...
    canvas.drawText(
      ...
      "Distance between Ankles: %.3f".format(distanceBetweenAnkles),
      (15.0f * widthRatio),
    ...
    canvas.drawText(
      ...
      "Distance Left Ankle To Hip: %.3f".format(distanceLeftAnkleToLeftHip),
      (15.0f * widthRatio),
    ...
    canvas.drawText(
      ...
      "Distance Right Ankle To Hip: %.3f".format(distanceRightAnkleToRightHip),
      (15.0f * widthRatio),
    ...
    canvas.drawText(
      ...
      "Distance Left Ankle to Nose: %.3f".format(distanceLeftAnkleToNose),
      (15.0f * widthRatio),
